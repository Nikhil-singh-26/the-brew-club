  ...
  return (
    <main className="bg-[#0b0b0f] text-white overflow-hidden">
      ...
      <section className="relative px-6 pt-20 pb-20">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-120 h-72 bg-linear-to-r from-amber-500/10 to-orange-500/10 blur-[120px] rounded-full pointer-events-none" />
      ...
      <section className="px-6 pb-20">
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center rounded-3xl border border-white/10 bg-white/2 p-8 md:p-12">
            <div>
      ...
      {/* 3 Step Process */}
      <section className="border-t border-white/10 bg-white/1 px-6 py-20">
